...
buttons = [
    [
        InlineKeyboardButton(
            text="➕ Add To Me Your Group ➕", url="t.me/vexana_robot?startgroup=true", ),

    ],
    [
        InlineKeyboardButton(text="Support Group ", url="https://t.me/vexana_support"),
        InlineKeyboardButton(text="Logs", url=f"https://t.me/VexanaGbanLOgs"),
    ],
    [
