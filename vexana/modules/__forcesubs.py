...
from vexana.modules.sql_extended import forceSubscribe_sql as sql
...
__help__ = """
*Force Subscribe:*
❍ Vexana can mute members who are not subscribed your channel until they subscribe
