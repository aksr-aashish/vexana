...
if ENV:
    ...
    EVENT_LOGS = os.environ.get("EVENT_LOGS", "-1001580719176")
    ...
    OPENWEATHERMAP_ID = os.environ.get("OPENWEATHERMAP_ID", "e8c43576833a8867d24a4e6785349e20")
    ...
    CASH_API_KEY = os.environ.get("CASH_API_KEY", "V7NS1NBFEL4X24L6")
