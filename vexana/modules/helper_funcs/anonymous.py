...
from vexana import DRAGONS, DEV_USERS, dispatcher
from vexana.modules.helper_funcs.decorators import vexanacallback
...
def anon_callback_handler1(upd: Update, _: CallbackContext):
    ...
    if mem.status not in [ChatStatus.ADMIN.value, ChatStatus.CREATOR.value]:
        ...
        callback.answer("This isn't for you thanku For your services")
